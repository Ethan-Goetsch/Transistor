...
public class IndexCalculator {
    ...
    static {
        ...
        amenityWeights.put("clinic", new Double[]{0.5, 0.8});
        amenityWeights.put("nursing_home", new Double[]{0.2, 0.2});
        amenityWeights.put("doctors", new Double[]{0.6, 0.8});
        amenityWeights.put("dentist", new Double[]{0.5, 0.6});
        ...
        amenityWeights.put("ice_cream", new Double[]{0.4, 0.7});
        amenityWeights.put("shop", new Double[]{0.9, 0.9});
        amenityWeights.put("hunting_stand", new Double[]{0.1, 0.1});
        amenityWeights.put("marketplace", new Double[]{0.6, 0.8});
        ...
        amenityWeights.put("library", new Double[]{0.4, 0.5});
        ...
        amenityWeights.put("police", new Double[]{0.5, 0.5});
        ...
        amenityWeights.put("place_of_worship", new Double[]{0.3, 0.3});
        amenityWeights.put("community_centre", new Double[]{0.4, 0.8});
        amenityWeights.put("social_facility", new Double[]{0.4, 0.7});
        amenityWeights.put("shelter", new Double[]{0.3, 0.6});
        ...
        amenityWeights.put("recycling", new Double[]{0.8, 0.8});
        amenityWeights.put("waste_basket", new Double[]{0.2, 0.2});
        amenityWeights.put("fuel", new Double[]{0.7, 0.7});
        amenityWeights.put("car_wash", new Double[]{0.2, 0.2});
        ...
        amenityWeights.put("car_rental", new Double[]{0.2, 0.8});
        amenityWeights.put("parking_entrance", new Double[]{0.6, 0.6});
        amenityWeights.put("parking", new Double[]{1.0, 0.7});
        amenityWeights.put("parking_space", new Double[]{0.8, 0.8});
        amenityWeights.put("charging_station", new Double[]{0.4, 0.4});
        amenityWeights.put("apartment", new Double[]{0.6, 0.4});
        ...
        amenityWeights.put("convenience", new Double[]{0.1, 0.3});
        ...
        amenityWeights.put("car", new Double[]{0.1, 0.1});
        amenityWeights.put("sports", new Double[]{0.5, 0.5});
        amenityWeights.put("massage", new Double[]{0.1, 0.3});
        amenityWeights.put("storage_rental", new Double[]{0.1, 0.1});
        amenityWeights.put("hearing_aids", new Double[]{0.1, 0.4});
        amenityWeights.put("outdoor", new Double[]{0.3, 0.4});
