...
public class IndexCalculator
{
    ...
    static {
        ...
        amenityWeights.put("clinic", new Double[]{0.8, 1.0});
        amenityWeights.put("nursing_home", new Double[]{0.3, 0.7});
        amenityWeights.put("doctors", new Double[]{0.8, 1.0});
        amenityWeights.put("dentist", new Double[]{0.6, 0.8});
        amenityWeights.put("veterinary", new Double[]{0.5, 0.5});
        amenityWeights.put("pharmacy", new Double[]{0.8, 1.0});
        amenityWeights.put("theatre", new Double[]{0.3, 0.4});
        amenityWeights.put("arts_centre", new Double[]{0.3, 0.4});
        amenityWeights.put("cinema", new Double[]{0.4, 0.4});
        amenityWeights.put("nightclub", new Double[]{0.2, 0.2});
        amenityWeights.put("casino", new Double[]{0.1, 0.1});
        amenityWeights.put("restaurant", new Double[]{0.7, 0.6});
        amenityWeights.put("cafe", new Double[]{0.6, 0.4});
        amenityWeights.put("food_court", new Double[]{0.6, 0.7});
        amenityWeights.put("fast_food", new Double[]{0.5, 0.6});
        amenityWeights.put("pub", new Double[]{0.3, 0.2});
        amenityWeights.put("bar", new Double[]{0.4, 0.3});
        amenityWeights.put("ice_cream", new Double[]{0.1, 0.1});
        amenityWeights.put("shop", new Double[]{0.9, 0.8});
        amenityWeights.put("hunting_stand", new Double[]{0.01, 0.01});
        amenityWeights.put("marketplace", new Double[]{0.6, 0.6});
        amenityWeights.put("vending_machine", new Double[]{0.06, 0.06});
        amenityWeights.put("photo_booth", new Double[]{0.05, 0.05});
        amenityWeights.put("luggage_locker", new Double[]{0.1, 0.1});
        amenityWeights.put("library", new Double[]{0.6, 0.7});
        amenityWeights.put("public_bookcase", new Double[]{0.3, 0.4});
        amenityWeights.put("school", new Double[]{1.0, 0.9});
        amenityWeights.put("college", new Double[]{0.9, 0.9});
        amenityWeights.put("university", new Double[]{1.0, 0.9});
        amenityWeights.put("prep_school", new Double[]{0.8, 0.8});
        amenityWeights.put("childcare", new Double[]{0.6, 0.7});
        amenityWeights.put("tourism", new Double[]{0.3, 0.2});
        amenityWeights.put("police", new Double[]{0.6, 0.8});
        amenityWeights.put("courthouse", new Double[]{0.3, 0.3});
        amenityWeights.put("townhall", new Double[]{0.3, 0.5});
        amenityWeights.put("fire_station", new Double[]{0.9, 0.9});
        amenityWeights.put("post_office", new Double[]{0.6, 0.7});
        amenityWeights.put("post_box", new Double[]{0.5, 0.6});
        amenityWeights.put("atm", new Double[]{0.4, 0.5});
        amenityWeights.put("bank", new Double[]{0.5, 0.6});
        amenityWeights.put("bureau_de_change", new Double[]{0.1, 0.1});
        amenityWeights.put("place_of_worship", new Double[]{0.4, 0.5});
        amenityWeights.put("community_centre", new Double[]{0.3, 0.5});
        amenityWeights.put("social_facility", new Double[]{0.5, 0.6});
        amenityWeights.put("shelter", new Double[]{0.4, 0.5});
        amenityWeights.put("information", new Double[]{0.3, 0.4});
        amenityWeights.put("clock", new Double[]{0.05, 0.05});
        amenityWeights.put("binoculars", new Double[]{0.03, 0.03});
        amenityWeights.put("sanitary_dump_station", new Double[]{0.2, 0.2});
        amenityWeights.put("recycling", new Double[]{0.5, 0.5});
        amenityWeights.put("waste_basket", new Double[]{0.3, 0.3});
        amenityWeights.put("fuel", new Double[]{0.6, 0.5});
        amenityWeights.put("car_wash", new Double[]{0.3, 0.3});
        amenityWeights.put("taxi", new Double[]{0.4, 0.6});
        amenityWeights.put("bicycle_parking", new Double[]{0.4, 0.5});
        amenityWeights.put("moped_parking", new Double[]{0.2, 0.3});
        amenityWeights.put("car_rental", new Double[]{0.3, 0.4});
        amenityWeights.put("parking_entrance", new Double[]{0.2, 0.2});
        amenityWeights.put("parking", new Double[]{0.6, 0.6});
        amenityWeights.put("parking_space", new Double[]{0.7, 0.6});
        amenityWeights.put("charging_station", new Double[]{0.2, 0.2});
        amenityWeights.put("apartment", new Double[]{0.1, 0.1});
        amenityWeights.put("artwork", new Double[]{0.1, 0.1});
        amenityWeights.put("attraction", new Double[]{0.2, 0.2});
        amenityWeights.put("caravan_site", new Double[]{0.2, 0.2});
        amenityWeights.put("gallery", new Double[]{0.3, 0.3});
        amenityWeights.put("guest_house", new Double[]{0.2, 0.2});
        amenityWeights.put("hostel", new Double[]{0.3, 0.3});
        amenityWeights.put("hotel", new Double[]{0.4, 0.4});
        amenityWeights.put("museum", new Double[]{0.4, 0.4});
        amenityWeights.put("viewpoint", new Double[]{0.1, 0.1});
        amenityWeights.put("zoo", new Double[]{0.3, 0.4});
        amenityWeights.put("supermarket", new Double[]{0.7, 0.8});
        amenityWeights.put("greengrocer", new Double[]{0.6, 0.7});
        amenityWeights.put("bakery", new Double[]{0.5, 0.7});
        amenityWeights.put("butcher", new Double[]{0.5, 0.7});
        amenityWeights.put("medical_supply", new Double[]{0.6, 0.9});
        amenityWeights.put("convenience", new Double[]{0.4, 0.5});
        amenityWeights.put("hairdresser", new Double[]{0.3, 0.4});
        amenityWeights.put("nutrition_supplements", new Double[]{0.2, 0.3});
        amenityWeights.put("optician", new Double[]{0.5, 0.6});
        amenityWeights.put("books", new Double[]{0.4, 0.5});
        amenityWeights.put("car_parts", new Double[]{0.4, 0.4});
        amenityWeights.put("car", new Double[]{0.3, 0.4});
        amenityWeights.put("sports", new Double[]{0.6, 0.7});
        amenityWeights.put("massage", new Double[]{0.3, 0.5});
        amenityWeights.put("storage_rental", new Double[]{0.1, 0.1});
        amenityWeights.put("hearing_aids", new Double[]{0.6, 0.9});
        amenityWeights.put("outdoor", new Double[]{0.5, 0.8});
        amenityWeights.put("soft_drugs", new Double[]{0.2, 0.2});
        amenityWeights.put("dry_cleaning", new Double[]{0.4, 0.5});
        amenityWeights.put("market", new Double[]{0.5, 0.6});
    }
    ...
    private static double calculator(double[] weights, double[] times) {
        final double beta = 0.1; // Adjust beta if needed based on time units (minutes here)
    ...
    private static double calculateMaxAccessibility(double[] normalizedValues, double beta) {
        ...
        for (int i = 0; i < normalizedValues.length; i++) {
            maxAccessibility += normalizedValues[i] * Math.exp(-beta * 0.5); // Assume minimum travel time of 0.5 minute
        }
